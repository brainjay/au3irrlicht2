...
// IrrlichtWrapper
//! A material that uses the RGBA of the vertex color as 4 alpha
//| channels that it applies to mix in four greyscale images in the
//! RGBA of the first texture the resultant mixed detail map is then
//! modulated with the second color channel
class COpenGLMaterialRenderer_FOUR_DETAIL : public COpenGLMaterialRenderer
{
public:

	COpenGLMaterialRenderer_FOUR_DETAIL(video::COpenGLDriver* d)
		: COpenGLMaterialRenderer(d) {}
...
//! Transparent alpha channel material renderer
class COpenGLMaterialRenderer_TRANSPARENT_ADD_ALPHA_CHANNEL_REF : public COpenGLMaterialRenderer
{
public:

	COpenGLMaterialRenderer_TRANSPARENT_ADD_ALPHA_CHANNEL_REF(video::COpenGLDriver* d)
		: COpenGLMaterialRenderer(d) {}
...
class COpenGLMaterialRenderer_TRANSPARENT_ADD_ALPHA_CHANNEL : public COpenGLMaterialRenderer
{
public:

	COpenGLMaterialRenderer_TRANSPARENT_ADD_ALPHA_CHANNEL(video::COpenGLDriver* d)
		: COpenGLMaterialRenderer(d) {}
