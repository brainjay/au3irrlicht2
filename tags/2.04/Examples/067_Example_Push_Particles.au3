...
; ----------------------------------------------------------------------------
; Example 67: Push Particle Effect
; This example demonstrates the use of the push effector that can push
; particles over limited distances and with differing forces, it is usefull
; when creating natural smoke like particle movements
; ----------------------------------------------------------------------------
...
_IrrSetWindowCaption( "Example 67: Pushing particles with the Push Affector" )
...
$SmokeEmitter = __CreateParticleSettings( _
					...
					20, 60, _			; min_paritlcles_per_second / max_paritlcles_per_second
...
; out particle system is not affected by lighting so we make it self illuminating
