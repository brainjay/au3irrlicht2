...
; ----------------------------------------------------------------------------
; Example 68: Colour Particle Effect
; This example demonstrates the particle colouring effector
; ----------------------------------------------------------------------------
...
_IrrSetWindowCaption( "Example 68: Highly colored particles with the color affector" )
...
$SmokeEmitter = __CreateParticleSettings( _
					...
					30, 50, _			; min_paritlcles_per_second / max_paritlcles_per_second
...
_IrrAddGravityParticleAffector ( $SmokeParticles, 0.0, 0.075, 0.0 )

; change the color of particles using a particle table
DIM $colors[5] = [  _IrrMakeARGB(0,255,255,128), _	; yellow white
					_IrrMakeARGB(0,255,128,0), _ 	; yellow
                    _IrrMakeARGB(0,128,64,0), _ 	; orange
					_IrrMakeARGB(0,0,0,128), _ 		; slight blue
					_IrrMakeARGB(255,0,0,0) ] 		; black and faded
DIM $times[5] = [500, 800, 1250, 1500, 2000]
_IrrAddColorMorphAffector ( $SmokeParticles, $colors, $times, $IRR_ON )
