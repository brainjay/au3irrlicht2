...
_IrrSetWindowCaption( "Example 66: Automatically Stopping Particle Emissions" )
...
; stop the emision of particles from the smoke emitter after 3000 ms
_IrrAddStopParticleAffector( $SmokeParticles, 3000, $smoke_emitter )
