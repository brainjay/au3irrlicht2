...
void CD3D8Driver::createMaterialRenderers()
{
	...
	addAndDropMaterialRenderer(new CD3D8MaterialRenderer_FOUR_DETAIL_MAP(pID3DDevice, this));

	// add an alpha ref transparency effect that adds to the vertex color so it can be tinted
	addAndDropMaterialRenderer(new CD3D8MaterialRenderer_TRANSPARENT_ADD_ALPHA_CHANNEL_REF(pID3DDevice, this));

	// add an alpha ref transparency effect that adds to the vertex color so it can be tinted
	addAndDropMaterialRenderer(new CD3D8MaterialRenderer_TRANSPARENT_ADD_ALPHA_CHANNEL(pID3DDevice, this));
	//! IrrlichtWrapper End
}
