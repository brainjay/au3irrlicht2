...
Func Main()
   ...
   FileWriteLine($FO_TOC_HND, '<UL>')
   FileWriteLine($FO_TOC_HND, '<LI> <OBJECT type="text/sitemap">')
   FileWriteLine($FO_TOC_HND, '<param name="Name" value="Irrlicht Wrapper Reference">')
   FileWriteLine($FO_TOC_HND, '<param name="Local" value="html_static\FB_Documentation\The Irrlicht Wrapper Reference.htm">')
   FileWriteLine($FO_TOC_HND, '</OBJECT>')
   FileWriteLine($FO_TOC_HND, '<LI> <OBJECT type="text/sitemap">')
   FileWriteLine($FO_TOC_HND, '<param name="Name" value="Irrlicht Wrapper Release notes">')
   FileWriteLine($FO_TOC_HND, '<param name="Local" value="html_static\FB_Documentation\The Irrlicht Wrapper Release Notes.htm">')
   FileWriteLine($FO_TOC_HND, '</OBJECT>')
   FileWriteLine($FO_TOC_HND, '<LI> <OBJECT type="text/sitemap">')
   FileWriteLine($FO_TOC_HND, '<param name="Name" value="Irrlicht Wrapper Platform support">')
   FileWriteLine($FO_TOC_HND, '<param name="Local" value="html_static\FB_Documentation\The Irrlicht Wrapper Platform Support.htm">')
   FileWriteLine($FO_TOC_HND, '</OBJECT>')
   FileWriteLine($FO_TOC_HND, '<LI> <OBJECT type="text/sitemap">')
   FileWriteLine($FO_TOC_HND, '<param name="Name" value="IrrKlang Wrapper Introduction">')
   FileWriteLine($FO_TOC_HND, '<param name="Local" value="html_static\FB_Documentation\The IrrKlang Wrapper Introduction.htm">')
   FileWriteLine($FO_TOC_HND, '</OBJECT>')
   FileWriteLine($FO_TOC_HND, '<LI> <OBJECT type="text/sitemap">')
   FileWriteLine($FO_TOC_HND, '<param name="Name" value="IrrKlang Wrapper Reference">')
   FileWriteLine($FO_TOC_HND, '<param name="Local" value="html_static\FB_Documentation\The IrrKlang Wrapper Reference.htm">')
   FileWriteLine($FO_TOC_HND, '</OBJECT>')
   FileWriteLine($FO_TOC_HND, '</UL>')
