...
//! Irrlicht Wrapper: Four greyscale detail maps
class CD3D9MaterialRenderer_FOUR_DETAIL_MAP : public CD3D9MaterialRenderer
{
public:

	CD3D9MaterialRenderer_FOUR_DETAIL_MAP(IDirect3DDevice9* p, video::IVideoDriver* d)
		: CD3D9MaterialRenderer(p, d) {}
		...
		bool resetAllRenderstates, IMaterialRendererServices* services)
	{
		...
		{
            // ///////////////////////////////////////////////////////////////
            // Working DOT3 + ALPHA texture combination for terrains
            // ///////////////////////////////////////////////////////////////
			pID3DDevice->SetRenderState(D3DRS_ALPHABLENDENABLE, TRUE);
			pID3DDevice->SetRenderState(D3DRS_SRCBLEND, D3DBLEND_INVSRCALPHA);
			pID3DDevice->SetRenderState(D3DRS_DESTBLEND, D3DBLEND_ZERO);


            pID3DDevice->SetTextureStageState( 0, D3DTSS_TEXCOORDINDEX, 0 );

			pID3DDevice->SetTextureStageState( 0, D3DTSS_COLOROP, D3DTOP_DOTPRODUCT3);
			...
			pID3DDevice->SetTextureStageState (1, D3DTSS_COLORARG2, D3DTA_CURRENT | D3DTA_COMPLEMENT);
...
//! Transparent alpha channel material renderer
class CD3D9MaterialRenderer_TRANSPARENT_ADD_ALPHA_CHANNEL_REF : public CD3D9MaterialRenderer
{
public:

	CD3D9MaterialRenderer_TRANSPARENT_ADD_ALPHA_CHANNEL_REF(IDirect3DDevice9* p, video::IVideoDriver* d)
		: CD3D9MaterialRenderer(p, d) {}
		...
		bool resetAllRenderstates, IMaterialRendererServices* services)
	{
		if (material.MaterialType != lastMaterial.MaterialType || resetAllRenderstates)
		{
			pID3DDevice->SetTextureStageState( 0, D3DTSS_COLOROP,   D3DTOP_ADD );
			pID3DDevice->SetTextureStageState( 0, D3DTSS_COLORARG1, D3DTA_TEXTURE );
...
//! Transparent alpha channel material renderer
class CD3D9MaterialRenderer_TRANSPARENT_ADD_ALPHA_CHANNEL : public CD3D9MaterialRenderer
{
public:

	CD3D9MaterialRenderer_TRANSPARENT_ADD_ALPHA_CHANNEL(IDirect3DDevice9* p, video::IVideoDriver* d)
		: CD3D9MaterialRenderer(p, d) {}
