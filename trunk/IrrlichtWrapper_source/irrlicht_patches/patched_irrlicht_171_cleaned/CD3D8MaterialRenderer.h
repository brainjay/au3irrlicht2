...
//! IrrlichtWrapper: Four Greyscale detail maps
class CD3D8MaterialRenderer_FOUR_DETAIL_MAP : public CD3D8MaterialRenderer
{
public:

	CD3D8MaterialRenderer_FOUR_DETAIL_MAP(IDirect3DDevice8* p, video::IVideoDriver* d)
		: CD3D8MaterialRenderer(p, d) {}
...
//! Transparent alpha channel material renderer
class CD3D8MaterialRenderer_TRANSPARENT_ADD_ALPHA_CHANNEL_REF : public CD3D8MaterialRenderer
{
public:

	CD3D8MaterialRenderer_TRANSPARENT_ADD_ALPHA_CHANNEL_REF(IDirect3DDevice8* p, video::IVideoDriver* d)
		: CD3D8MaterialRenderer(p, d) {}
...
//! Transparent alpha channel material renderer
class CD3D8MaterialRenderer_TRANSPARENT_ADD_ALPHA_CHANNEL : public CD3D8MaterialRenderer
{
public:

	CD3D8MaterialRenderer_TRANSPARENT_ADD_ALPHA_CHANNEL(IDirect3DDevice8* p, video::IVideoDriver* d)
		: CD3D8MaterialRenderer(p, d) {}
